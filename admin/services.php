    ...
    <!-- ============================================== dash body ==================================================== -->
            <div class="all-dash-body">
                ...
                <div class="service-content">
                    ...
                    <a href="./buy-airtime"><div class="service-item">
                        <div class="service-top">
                            <div class="service-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="currentColor">
                                        <path d="M8.25 14.5c2-2 5.5-2 7.5 0m2.75-3c-3.768-3.333-9-3.333-13 0" />
                                        <path d="M2 8.5c6.316-5.333 13.684-5.333 20 0" />
                    ...
                    <a href="./buy-databundle"><div class="service-item">
                        <div class="service-top">
                            <div class="service-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                        <path d="M10 4v16l-6-5.5" />
                                        <path d="M14 20V4l6 5.5" opacity="0.5" />
                                    </g>
                                </svg>
                            </div>
                            <div class="service-title">
                    ...
                    <a href="./electricity"><div class="service-item">
                        <div class="service-top">
                            <div class="service-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" stroke-width="1.5">
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m12.786 8.5l-2.143 3h3l-2.143 3" opacity="0.5" />
                                    </g>
                                </svg>
                            </div>
                            <div class="service-title">
                    ...
                    <div class="service-item">
                        <div class="service-top">
                            <div class="service-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" stroke-width="1.5">
                                        <path stroke-linecap="round" d="M22 22H2m0-11l8.126-6.5a3 3 0 0 1 3.748 0L22 11" />
                                        <path stroke-linecap="round" d="M15.5 5.5v-2A.5.5 0 0 1 16 3h2.5a.5.5 0 0 1 .5.5v5" opacity="0.5" />
                                        <path stroke-linecap="round" d="M4 22V9.5M20 22V9.5" />
                                        <path d="M15 22v-5c0-1.414 0-2.121-.44-2.56C14.122 14 13.415 14 12 14s-2.121 0-2.56.44C9 14.878 9 15.585 9 17v5m5-12.5a2 2 0 1 1-4 0a2 2 0 0 1 4 0Z" opacity="0.5" />
                                    </g>
                                </svg>
                            </div>
                            <div class="service-title">
                            ...
                            <div class="service-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <g fill="none" stroke="currentColor" stroke-width="1.5">
                                        ...
                                        <path stroke-linecap="round" d="M10 16.5H6m2-3H6M2 10h20" opacity="0.5" />
                                        <path d="M14 15c0-.943 0-1.414.293-1.707S15.057 13 16 13s1.414 0 1.707.293S18 14.057 18 15s0 1.414-.293 1.707S16.943 17 16 17s-1.414 0-1.707-.293S14 15.943 14 15Z" opacity="0.5" />
                                    </g>
                                </svg>
                            </div>
                            <div class="service-title">
