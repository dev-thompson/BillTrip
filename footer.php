    ...
    <div class="footer-content margin">
        <div class="footer-left">
            ...
            <div class="footer-price">
                <img src="./assets/image/footer-price-payment-icon.png" alt="">
            </div>
        </div>
        ...
        <div class="footer-center">
            <h4>Support</h4>
            <a href=""><p><i class=" fa fa-play" style="font-size: 0.5rem;"></i>Support</p></a>
            <a href=""><p><i class=" fa fa-play" style="font-size: 0.5rem;"></i>Contact Us</p></a>
            <a href=""><p><i class=" fa fa-play" style="font-size: 0.5rem;"></i>Services</p></a>
        </div>
