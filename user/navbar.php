                        ...
                        <div class="right-notify">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <g fill="none" stroke="currentColor" stroke-width="1.5">
                                    ...
                                    <path stroke-linecap="round" d="M7.5 19c.655 1.748 2.422 3 4.5 3s3.845-1.252 4.5-3M12 6v4" opacity="0.5" />
                                </g>
                            </svg>
                        </div>
                        <div class="profile-nav">
                            <div id="profile-pic" class="right-profile">
                                <img src="./assets/image/20250311_152604.jpg" alt="">
                            </div>
                            <div id="profile-item" class="profile-nav-items">
                                <div class="first-item p-3">
                                    <h6>Welcome John!</h6>
                                    <a href="./settings"><div class="profile-item pb-2 mb-1">
                                ...
                                <div class="line"></div>
                                <div class="profile-item p-3" style="color: #ff6600d0; font-weight: 500;">
