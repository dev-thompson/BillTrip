  <div id="sidebars">
            ...
            <div class="dash-sidebar-content mt-3">
                    ...
                    <div class="sidebar-item-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <g fill="none" stroke="currentColor" stroke-width="1">
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.991 13H18" opacity="0.5" />
                            </g>
                        </svg>
                ...
                <a href="./payment-history"><div class="sidebar-items" onclick="toggleMenu('payment', event)">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5">
                            ...
                            <path stroke-linejoin="round" d="M20 20v-6m0 0l2 2m-2-2l-2 2" opacity="0.5" />
                            <path stroke-linejoin="round" d="M15.5 14v6m0 0l2-2m-2 2l-2-2" />
                            <path d="M10 16H6" opacity="0.5" />
                ...
                <div class="sidebar-items" onclick="toggleMenu('support', event)">
                    <div class="sidebar-item-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="none">
                ...
                <div class="sidebar-items" onclick="toggleMenu('contact', event)">
                    <div class="sidebar-item-1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5">
                            <path d="M14 2s2.2.2 5 3s3 5 3 5m-7.793-4.464s.99.282 2.475 1.767s1.768 2.475 1.768 2.475" />
                            <path d="m10.038 5.316l.649 1.163c.585 1.05.35 2.426-.572 3.349q0 0 0 0s-1.12 1.119.91 3.148c2.027 2.027 3.146.91 3.147.91q0 0 0 0c.923-.923 2.3-1.158 3.349-.573l1.163.65c1.585.884 1.772 3.106.379 4.5c-.837.836-1.863 1.488-2.996 1.53c-1.908.073-5.149-.41-8.4-3.66c-3.25-3.251-3.733-6.492-3.66-8.4c.043-1.133.694-2.159 1.53-2.996c1.394-1.393 3.616-1.206 4.5.38Z" opacity="0.5" />
                        </g>
                    </svg>
                    <label>Contact</label>
                    </div>
                ...
                <div class="sidebar-items" onclick="toggleMenu('authentication-1', event)">
                    ...
                    <label>Authentication</label>
                     ...
                     <div class="submenu" id="authentication-1">
                        ...
                        <p><a href="../reset-password"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><g fill="none"><path fill="currentColor" d="M4 11.25a.75.75 0 0 0 0 1.5zm0 1.5h16v-1.5H4z" opacity="0.5"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m14 6l6 6l-6 6"/></g></svg> Reset Password</a></p>
                        <p><a href="../verify-email"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><g fill="none"><path fill="currentColor" d="M4 11.25a.75.75 0 0 0 0 1.5zm0 1.5h16v-1.5H4z" opacity="0.5"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m14 6l6 6l-6 6"/></g></svg> Verify Email</a></p>
                    </div>
                </div>
